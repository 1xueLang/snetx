...
from snetx.snn.nnfunc import stbpLIF, detachedLIF
...
class IF(LIF):
    def __init__(self, v_th: float = 1.0, v_reset: float = 0.0, 
                 sg: str = 'arctan', alpha = lambda : 4.0, detach: bool = False
                 ) -> None:
